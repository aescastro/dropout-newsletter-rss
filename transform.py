...
def transform_feed(kill_the_newsletter_url: str, output_dir: str = './feeds', base_url: str = "") -> dict:
    """
    ...
    for show_name, show_episodes in shows.items():
        ...
        feed_xml = generate_rss_feed(show_name, show_episodes, base_url)
    ...
    all_shows_xml = generate_all_shows_feed(episodes, base_url)
...
def main():
    ...
    # Run transformation
    transform_feed(feed_url, output_dir, base_url)
